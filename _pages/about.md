...
title: about
permalink: /
subtitle: Undergraduate Researcher at <a href='https://www.jhu.edu/'>Johns Hopkins University</a>
...
I am currently a research assistant in the [Hicks Lab](https://www.stephaniehicks.com/) at the Johns Hopkins Department of Biostatistics, where I develop computational methods, software, and reproducible workflows for spatial transcriptomics and RNA-seq analysis. My recent work includes building isoform-level machine learning models for human brain aging, which I presented as a [poster at Biology of Genomes, Cold Spring Harbor Laboratory, 2026](/assets/pdf/Chen_BoG_2026_poster.pdf); developing reusable Visium HD preprocessing, quality-control, destriping, and visualization workflows through the Python package [`visiumhd-utils`](https://github.com/danielchen05/visiumhd_utils); porting SpotSweeper from R/Bioconductor to Python and releasing it as a Python package ([GitHub](https://github.com/danielchen05/spotsweeper_py), [PyPI](https://pypi.org/project/spotsweeper/)); and benchmarking gene panel selection methods for spatial transcriptomics.
